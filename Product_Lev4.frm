...
'===
  If SearchDefect = True Then
       If Cn = 0 Then
         ...
         UText(20320, 26410, 36873, 25321, 20219, 20309, 20135, 21697, 65292, 35831, 36873, 25321, 19968, 20010, 20135, 21697, 26469, 26597, 35810, 20854, 32570, 38519, 25551, 36848, 12290) & CHR(10), vbCritical
         Unload Me
         Load_Product_Lev4
       ElseIf Cn > 1 Then
         ...
         UText(20320, 36873, 25321, 20102, 22810, 20010, 20135, 21697, 65292, 35831, 20165, 36873, 25321, 19968, 20010, 20135, 21697, 26469, 26597, 35810, 20854, 32570, 38519, 25551, 36848, 12290) & CHR(10), vbCritical
         Unload Me
         Load_Product_Lev4
       Else
 ...
 Else
      If Cn = 0 Then
           ...
           UText(20320, 26410, 36873, 25321, 20219, 20309, 20135, 21697, 21517, 31216, 65292, 23558, 25353, 29031, 25152, 36873, 30340, 20135, 21697, 23567, 31867, 26597, 35810, 26816, 26597, 39033, 30446, 12290) & CHR(10), vbCritical
           Unload Me
           Load_Product_Lev4
       ElseIf Cn > 10 Then
            MsgBox "You have selected " & Cn & " products, no more than 10 products allowed to be selected，Please select again." & CHR(10) & _
           UText(20320, 36873, 25321, 20102) & Cn & UText(20010, 20135, 21697, 65292, 27880, 24847, 27599, 27425, 21482, 20801, 35768, 36873, 25321, 26368, 22810, 49, 48, 31181, 20135, 21697, 65292, 35831, 37325, 26032, 36873, 25321, 65281) & CHR(10), vbCritical
            Unload Me
            Load_Product_Lev4
       Else
         'Me.Hide
