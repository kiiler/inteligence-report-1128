...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Product_ForDefects 
   Caption         =   "Please select one product for searching its defect list"
   ClientHeight    =   7504
   ClientLeft      =   91
   ClientTop       =   406
...
Set UF = Me
 ...
 If Cn = 0 Then
    ...
    UText(20320, 26410, 36873, 25321, 20219, 20309, 20135, 21697, 21517, 31216) & "，" & UText(35831, 36873, 25321) & "1" & UText(20010, 20135, 21697, 26469, 25628, 32034, 20854, 24120, 35265, 30340, 32570, 38519, 21015, 34920) & "。" & CHR(10), vbCritical
 ...
 ElseIf Cn > 1 Then
    ...
    UText(20320, 36873, 25321, 20102, 22810, 20010, 20135, 21697) & "，" & UText(27599, 27425, 21482, 20801, 35768, 36873, 25321) & "1" & UText(20010, 20135, 21697, 26469, 26597, 35810, 20854, 24120, 35265, 32570, 38519, 21015, 34920) & "," & UText(35831, 37325, 26032, 36873, 25321) & "。" & CHR(10), vbCritical
    Load_Product_ForDefects
 End If
