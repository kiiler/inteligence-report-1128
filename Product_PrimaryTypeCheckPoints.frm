...
'===
 ...
 If Cn = 0 Then
    ...
    UText(20320, 26410, 36873, 25321, 20219, 20309, 27979, 35797, 39033, 30446) & "，" & UText(35831, 33267, 23569, 36873, 25321, 19968, 20010, 27979, 35797, 39033, 30446, 25110, 32773, 28857) & "Cancel" & UText(36864, 20986) & "。" & CHR(10), vbCritical
        Unload Me
