...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Product_DefectList 
   Caption         =   "Please select defects (multiple choices are allowed)"
   ClientHeight    =   7504
   ClientLeft      =   91
   ClientTop       =   406
...
'===
 ...
 If Cn = 0 Then
    ...
    UText(20320, 26410, 36873, 25321, 20219, 20309, 32570, 38519, 65292, 35831, 33267, 23569, 36873, 25321, 19968, 20010, 32570, 38519, 12290) & CHR(10), vbCritical
        Unload Me
...
'===
 ...
 ElseIf Cn > 1 Then
    ...
    UText(20320, 36873, 25321, 20102, 19981, 27490, 19968, 20010, 32570, 38519, 65292, 35831, 21482, 36873, 25321, 19968, 20010, 32570, 38519, 12290) & CHR(10), vbCritical
     Load Me
 Else
      ...
      '---
       SearchResult = GetSearchResult(KeyWords)
        ...
        If Cn > 0 Then
            ...
            cmb.Text = KeyWords ' Keep current text
...
Private Sub cmb_click()
       ...
       If cmb.ListIndex >= 0 Then
        ' Set selected value as ComboBox text
...
Private Function GetSearchResult(KeyWords As String) As String()
    ' Filtering logic should be implemented here; example code below
    Dim SearchResult() As String
